...
public class SecretRightTwoCycle extends SequentialCommandGroup {
    
    public SecretRightTwoCycle(PathPlannerPath... paths) {
        ...
        addCommands(
            ...
            CommandSwerveDrivetrain.getInstance().followPathCommand(paths[0]).alongWith(
                new WaitCommand(0.8).andThen(new IntakeDeploy())
            ),
